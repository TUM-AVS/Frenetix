...
CalculateCollisionProbabilityMahalanobis::CalculateCollisionProbabilityMahalanobis(std::string funName, double costWeight, std::map<int, PoseWithCovariance> predictions)
