...
CalculateCollisionProbabilityFast::CalculateCollisionProbabilityFast(std::map<int, std::map<std::string, RowMatrixXd>> predictions, double vehicleLength, double vehicleWidth)
    : CostStrategy("Prediction Cost")
