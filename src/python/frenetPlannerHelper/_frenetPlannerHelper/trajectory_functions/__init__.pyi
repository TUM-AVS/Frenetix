...
class FillCoordinates(TrajectoryStrategy):
    def __init__(self, lowVelocityMode: bool, initialOrientation: float, coordinateSystem: frenetPlannerHelper._frenetPlannerHelper.CoordinateSystemWrapper) -> None: ...
...
class ComputeInitialState(TrajectoryStrategy):
    def __init__(self, coordinateSystem: frenetPlannerHelper._frenetPlannerHelper.CoordinateSystemWrapper, wheelBase: float, steeringAngle: float, lowVelocityMode: bool) -> None: ...
    def evaluate_trajectory(self, trajectory: frenetPlannerHelper._frenetPlannerHelper.TrajectorySample) -> None: ...
    pass
